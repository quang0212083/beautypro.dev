...
require_once ('VimeoExceptions'.DS.'ExceptionInterface.php');
require_once ('VimeoExceptions'.DS.'VimeoUploadException.php');
require_once ('VimeoExceptions'.DS.'VimeoRequestException.php');
