...
class JDate extends DateTime
{
	...
	public function dayToString($day, $abbr = false)
	{
		...
		{
			case 0:
				return $abbr ? JText::_('SUN') : JText::_('Chủ Nhật');
			case 1:
				return $abbr ? JText::_('MON') : JText::_('Thứ 2');
			case 2:
				return $abbr ? JText::_('TUE') : JText::_('Thứ 3');
			case 3:
				return $abbr ? JText::_('WED') : JText::_('Thứ 4');
			case 4:
				return $abbr ? JText::_('THU') : JText::_('Thứ 5');
			case 5:
				return $abbr ? JText::_('FRI') : JText::_('Thứ 6');
			case 6:
				return $abbr ? JText::_('SAT') : JText::_('Thứ 7');
		}
	}
	...
	public function monthToString($month, $abbr = false)
	{
		...
		{
			case 1:
				return $abbr ? JText::_('JANUARY_SHORT') : JText::_('Tháng Giêng');
			case 2:
