...
class modRelatedItemHelper {
    ...
    function getItems(&$params, $format = 'html') {
        ...
        //CUSTOM ADDED BY TARIK for item exclusion
        $exclude = $params->get('itemExclude');
        ...
        if($params->get('source')=='specific'){
            ...
            //CUSTO ADDED BY TARIK for item exclusion
            if ($params->get('itemExclude'))
            $query .= " AND i.id NOT IN ($exclude)";
