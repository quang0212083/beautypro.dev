...
/*
 * @version		$Id: default_add.php 3.1 2012-11-28 $
 * @package		Joomla
...
<form action="index.php?option=com_hdwplayer&view=add" method="post" name="adminForm" id="adminForm" onsubmit="return submitbutton();" enctype="multipart/form-data">
  <div id="tbl">
