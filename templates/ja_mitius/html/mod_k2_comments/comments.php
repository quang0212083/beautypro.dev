...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2LatestCommentsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	...
	<ul>
		...
		<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($comments)==$key+1) echo ' lastItem'; ?>">
			...
			<a class="lcComment" href="<?php echo $comment->link; ?>"><span class="lcComment"><strong class="arrow">&nbsp;</strong><?php echo $comment->commentText; ?></span></a>
			<?php else: ?>
			<span><strong class="arrow">&nbsp;</strong><?php echo $comment->commentText; ?></span>
			<?php endif; ?>
