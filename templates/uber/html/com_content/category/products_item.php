...
<?php endif; ?>
	...
	<article>
        ...
        <?php 
					...
					if($title_caption):	echo $title_caption; 	endif;
				?>
			</div>
		...
		<?php if (($topInfo || $icons) || $botInfo || ($params->get('show_tags', 1) && !empty($this->item->tags)) || ($params->get('show_readmore') && $this->item->readmore) ) : ?>
