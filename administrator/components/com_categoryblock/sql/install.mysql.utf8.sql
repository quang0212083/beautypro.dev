CREATE TABLE IF NOT EXISTS `#__categoryblock` (
  ...
  `categorytitlecssstyle` varchar(255) NOT NULL,
  `categorydescriptioncssstyle` varchar(255) NOT NULL,

  `allowcontentplugins` tinyint(1) NOT NULL,
  `storethumbnails` smallint(6) NOT NULL,
  `thumbnailspath` varchar(255) NOT NULL,
