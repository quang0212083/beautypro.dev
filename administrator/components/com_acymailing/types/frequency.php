...
class frequencyType{
	...
	function frequencyType(){
		$this->txtDays = array(JText::_('Thứ 2'), JText::_('Thứ 3'), JText::_('Thứ 4'), JText::_('Thứ 5'), JText::_('Thứ 6'), JText::_('Thứ 7'), JText::_('Chủ Nhật'));
		$this->txtPos = array(JText::_('FREQUENCY_FIRST'), JText::_('FREQUENCY_SECOND'), JText::_('FREQUENCY_THIRD'), JText::_('FREQUENCY_LAST'));
		$this->days = array('Thứ 2', 'Thứ 3', 'Thứ 4', 'Thứ 5', 'Thứ 6', 'Thứ 7', 'Chủ Nhật');
